...
.directive('uiDate', ['ui.config', '$timeout', function (uiConfig, $timeout) { // *** Ryan Randall: $timeout added - see note below
  'use strict';
  var options;
  options = {};
      ...
      var initDateWidget = function () {
        ...
        if (controller) {
          var updateModel = function () {
            $timeout(function () { // *** Ryan Randall: changed from scope.$apply to $timeout since the former didn't close the dialog in IE. Is there a better workaround?
